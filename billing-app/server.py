...
AIRIA_API_KEY = os.environ.get("AIRIA_API_KEY",
    "ak-MTkyMzM3NTgwNnwxNzcxMjQ5MzY2MDM3fHRpLVNtOWx8MXwxMDQ1MTIyNTI5")
GUIDELINES_PIPELINE = os.environ.get("GUIDELINES_PIPELINE",
    "1b7a055f-d76a-4b04-8a05-6f9740556b68")
EVALUATOR_PIPELINE = os.environ.get("EVALUATOR_PIPELINE",
    "6a6e7667-aadf-4c06-a192-d538a2944d62")
MEMORY_ID = os.environ.get("MEMORY_ID",
    "4f0b47a7-ae0a-4b8f-8144-580dcca9b951")
...
if __name__ == "__main__":
    print(f"Billing Compliance App")
    print(f"  Guidelines: {GUIDELINES_PIPELINE}")
    print(f"  Evaluator:  {EVALUATOR_PIPELINE}")
    print(f"  Memory:     {MEMORY_ID}")
    print(f"  Airia:      {AIRIA_BASE}")
